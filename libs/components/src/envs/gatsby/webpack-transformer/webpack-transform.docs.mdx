...
setup with Bit to work correctly make sure you set `yarn` 
...
import { gatsbyPreviewConfigTransformer, gatsbyDevServerConfigTransformer } from '@bit-foundations/site-frameworks.gatsby.webpack-transforms';
