...
```js live
<Link href="https://www.watheia.io/home" external>
  Watheia
</Link>
```

Check out the [router link component documentation](https://bit.dev/watheia/base-ui/navigator/link) for more information on the link comoponent.
...
const packagesToExclude = ['@watheia/mfe.ui.link', '@teambit'];
